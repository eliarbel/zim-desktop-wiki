...
class TimeTrackerReportWindow(Gtk.Window):
    ...
    def _show_report(self, button):
        ...
        sorted_model.set_sort_column_id(5, Gtk.SortType.DESCENDING) # this will sort the table programmatically by col 5
    ...
    def _filter_raw_data(self, raw_entries):
        ...
        for i in range(len(raw_entries) - 1):
            ...
            if self._searchentry.get_text():
                if self._searchentry.get_text() not in entry_desc:
                    continue
